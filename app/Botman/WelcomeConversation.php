...
class WelcomeConversation extends Conversation 
{
    ...
    public function run()
    {
        $this->ask('What are you looking at about mango plantation ? <br><br> I. Mango verieties <br> II. Mango diseases <br> III. Details of verities <br> IV. Fertilizer <br> V. Instructions', function(Answer $answer) {
            ...
            if (preg_match("/mango verieties/i", strtolower($this->answerQ)) || strtolower($this->answerQ) == "i") {
            ...
            } else if (preg_match("/mango diseases/i", strtolower($this->answerQ)) || strtolower($this->answerQ) == "ii") {
            ...
            } else if (preg_match("/details/i", strtolower($this->answerQ)) || strtolower($this->answerQ) == "iii") {
                $this->bot->startConversation(new MangoDetailsConversation());
            } else if (preg_match("/fertilizer/i", strtolower($this->answerQ)) || strtolower($this->answerQ) == "iv") {
            ...
            } else if(preg_match("/instructions/i", strtolower($this->answerQ)) || strtolower($this->answerQ) == "v") {
