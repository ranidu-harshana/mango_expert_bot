<div class="wrapper row1">
    <header id="header" class="hoc clear"> 
      ...
      <nav id="mainav" class="fl_right">
        <ul class="clear">
          <li class="active "><a href="/" class="text-decoration-none">Home</a></li>
          <li><a class="drop text-decoration-none" href="#">Pages</a>
            <ul >
          ...
          <li><a class="drop text-decoration-none" href="#">Techniques</a>
            <ul>
              <li><a href="#" class="text-decoration-none">Land Preparation</a></li>
              <li><a href="#" class="text-decoration-none">Cultivation Practice</a></li>
              <li><a href="#" class="text-decoration-none">Harvest processing and packing</a></li>
            </ul>
      </nav>
