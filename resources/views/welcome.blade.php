  ...
  <div id="topbar" class="hoc clear"> 
    ...
    <div class="fl_left">
      <ul class="nospace inline pushright">
        <li><i class="fa fa-sign-in"></i> <a href="{{ route('login_form') }}">Login</a></li>
        <li><i class="fa fa-user"></i> <a href="{{ route('register_form') }}">Register</a></li>
      </ul>
    </div>
    <div class="fl_right">
...
<div class="wrapper row1">
  <header id="header" class="hoc clear"> 
    ...
    <div id="logo" class="fl_left">
      <h1><a href="index.html">Tree Plantation Instruction System</a></h1>
      <p></p>
    </div>
    ...
    <nav id="mainav" class="fl_right">
      <ul class="clear">
        ...
        <li><a class="drop" href="#">Pages</a>
          <ul>
            <li><a href="pages/gallery.html">Diseases and symptom</a></li>
            <li><a href="pages/full-width.html">Pests </a></li>
            <li><a href="pages/sidebar-left.html">Mango Varieties</a></li>
...
<div class="wrapper row5">
  <div id="copyright" class="hoc clear"> 
    ...
    <p class="fl_left">Copyright &copy; 2022 - All Rights Reserved - <a href="#">Chamath Pivithuru</a></p>
    <p class="fl_right">FOC@KDU </p>
